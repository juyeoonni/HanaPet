...
public class PetCalendarController {
    ...
    public ResponseEntity<List<PetCalendar>> getEventsOfPet(String event_date, String pet_id) {
    ...
    public ResponseEntity<List<PetCalendar>> getMonthEventsOfPet(String month, String pet_id) {
